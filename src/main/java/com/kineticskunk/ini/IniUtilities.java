...
public final class IniUtilities {
    ...
    /**
     * The new line character(s) that the com.kineticskunk.ini classes uses.
     */
     ...
     * @return boolean, true if the two com.kineticskunk.ini files have no sections with the 
     * same name, or true if the com.kineticskunk.ini files have two sections with the same name
